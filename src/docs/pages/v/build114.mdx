...
ac_add_options --disable-jit  #jit缺spectreZeroRegister
ac_add_options --without-wasm-sandboxed-libraries
ac_add_options --enable-debug   #测试的时候才用这个
```
...
```sh
cat > test_toolchain_configure.patch << EOF
